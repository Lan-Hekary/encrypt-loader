...
var aesKey = "Hw5u9QqBpfhMfrKSi6Dl";
var aesOpts = {
...
function Encrypt(data, options) {
  ...
  var res = "(function() {\n\t\tvar AES = require('encrypt-loader/lib/aes');\n\t\treturn AES.Decrypt('".concat(encrypted, "'").concat(options.string ? ',"string"' : "", ");\n\t})()");
  return res;
}
...
function Decrypt(str, retType) {
  ...
  if (retType == "string") return content;else return new Function("return " + content)();
}